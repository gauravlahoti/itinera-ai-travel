...
export default function Home() {
  ...
  const handlePlanTrip = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Trip generation failed:", msg);
      alert(msg);
            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  size="lg"
                  id="plan-trip-btn"
                  className="bg-white text-black hover:bg-white/90 rounded-xl px-8 py-6 h-auto text-base font-semibold group transition-all shadow-xl"
